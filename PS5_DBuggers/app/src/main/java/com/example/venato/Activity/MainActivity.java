...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showChart(R.id.activity_main_piechart,appUsageData, "Appography");
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        showChart(R.id.activity_main_piechart2,callType,"Types of Calls");
        //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        showChart(R.id.activity_main_piechart3,msgType, "SMS Stat");
        //////////////////////////////////////////////////////////////////////////////////////////////

        // DEBIT CREDIT
        ArrayList<PieEntry> debCr = new ArrayList<PieEntry>();
        debCr.add(new PieEntry( regMessage.getTotalDebited().floatValue(),"Debit"));
        debCr.add(new PieEntry( regMessage.getTotalCredited().floatValue(),"Credit"));
        showChart(R.id.activity_main_piechart4,debCr, "Debit Credit Share");
    ...
    private  void showChart(int grphId, ArrayList<PieEntry> entries, String gName){
        setupPieChart(grphId, gName);
        loadPieChartData(grphId, entries, gName);
    }

    private void setupPieChart(int grphId, String gName) {
        PieChart pieChart;
    ...
    private void loadPieChartData(int grphId, ArrayList<PieEntry> entries, String gName) {
        PieChart pieChart;
        pieChart = findViewById(grphId);
        ...
        PieDataSet dataSet = new PieDataSet(entries, gName);
